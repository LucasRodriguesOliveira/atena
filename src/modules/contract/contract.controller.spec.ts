...
describe('ContractController', () => {
  ...
  beforeEach(async () => {
    ...
    contractController = moduleRef.get<ContractController>(ContractController);
  });
  ...
  describe('Find', () => {
    ...
    it('should find a contract by id', async () => {
      const result = await contractController.find(contract.id);
  ...
  describe('List', () => {
    describe('ContracStatus.ACTIVE', () => {
      ...
      it('should return a list of contracts', async () => {
        const result = await contractController.list(queryContractDto);
  ...
  describe('Create', () => {
    ...
    it('should create a contract', async () => {
      const result = await contractController.create(createContractDto);
  ...
  describe('Update', () => {
    ...
    it('should  a service pack', async () => {
      const result = await contractController.update(
        contract.id,
        updateContractDto,
      );
  ...
  describe('Delete', () => {
    ...
    it('should  a service pack', async () => {
      const result = await contractController.delete(contract.id);
