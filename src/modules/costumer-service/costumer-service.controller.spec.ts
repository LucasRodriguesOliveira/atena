...
describe('CostumerServiceService', () => {
  ...
  beforeEach(async () => {
    ...
    controller = moduleRef.get<CostumerServiceController>(
  ...
  describe('Find', () => {
    ...
    it('should find a costumer service', async () => {
      const result = await controller.find(costumerService.id);
  ...
  describe('List', () => {
    ...
    it('should return a paginated list of costumer services', async () => {
      const result = await controller.list(queryCostumerServiceDto);
  ...
  describe('Create', () => {
    ...
    it('should create a costumer service', async () => {
      const result = await controller.create(createCostumerServiceDto);
  ...
  describe('Delete', () => {
    ...
    it('should soft delete a costumer service', async () => {
      const result = await controller.delete(costumerService.id);
