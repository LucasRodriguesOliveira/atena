...
describe('ServiceStageService', () => {
  ...
  beforeEach(async () => {
    ...
    service = moduleRef.get<ServiceStageService>(ServiceStageService);
  });
  ...
  describe('Find', () => {
    ...
    it('should find a serviceStage by id', async () => {
      const result = await service.find(serviceStage.id);
  ...
  describe('Create', () => {
    ...
    it('should create a serviceStage', async () => {
      const result = await service.create(createServiceStageDto);
  ...
  describe('Delete', () => {
    ...
    it('should soft delete a serviceStage', async () => {
      const result = await service.delete(serviceStageId);
