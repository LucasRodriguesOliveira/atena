...
describe('CoinService', () => {
  ...
  beforeEach(async () => {
    ...
    service = moduleRef.get<CoinService>(CoinService);
  });
  ...
  describe('Find', () => {
    ...
    describe('success', () => {
      ...
      it('should find a coin by id', async () => {
        const result = await service.find(coinId);
  ...
  describe('Create', () => {
    ...
    it('should create a coin', async () => {
      const result = await service.create(createCoinDto);
  ...
  describe('Update', () => {
    ...
    it('should update a coin', async () => {
      const result = await service.update(coin.id, updateCoinDto);
  ...
  describe('Delete', () => {
    ...
    it('should soft delete a coin', async () => {
      const result = await service.delete(coinId);
