...
describe('BlackListService', () => {
  ...
  beforeEach(async () => {
    ...
    service = moduleRef.get<BlackListService>(BlackListService);
  });
  ...
  describe('List', () => {
    ...
    it('should return a list of black list items', async () => {
      const result = await service.list(queryBlackListDto);
  ...
  describe('Create', () => {
    ...
    it('should create a black list item', async () => {
      const result = await service.create(createBlackListDto);
  ...
  describe('Update', () => {
    ...
    it('should update a black list item', async () => {
      const result = await service.update(reason.id, updateBlackListDto);
  ...
  describe('Delete', () => {
    ...
    it('should soft delete a reason', async () => {
      const result = await service.delete(blackListItem.id);
