...
describe('ServicePackController', () => {
  ...
  beforeEach(async () => {
    ...
    controller = moduleRef.get<ServicePackController>(ServicePackController);
  });
  ...
  describe('List', () => {
    ...
    it('should return a list of service packs', async () => {
      const result = await controller.list(queryListServicePackDto);
  ...
  describe('Create', () => {
    ...
    it('should create a service pack', async () => {
      const result = await controller.create(createServicePackDto);
  ...
  describe('Delete', () => {
    ...
    it('should delete a service pack', async () => {
      const result = await controller.delete(servicePackId);
