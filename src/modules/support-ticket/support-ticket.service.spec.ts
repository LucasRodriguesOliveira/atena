...
describe('SupportTicketService', () => {
  ...
  beforeEach(async () => {
    ...
    service = moduleRef.get<SupportTicketService>(SupportTicketService);
  });
  ...
  describe('Find', () => {
    ...
    it('should find a ticket by id', async () => {
      const result = await service.find(ticket.id);
  ...
  describe('List', () => {
    ...
    it('should return a list of tickets', async () => {
      const result = await service.list(querySupportTicketDto);
  ...
  describe('Delete', () => {
    ...
    it('should soft delete a ticket', async () => {
      const result = await service.delete(ticketId);
